...
FROM quay.io/almalinuxorg/almalinux-bootc:10.2@sha256:e617ff9ce67c0dad338c1fba839d7f66da37e80d787474b5c5272e6bb6187dcb AS base
...
RUN --mount=source=/httpd,target=/httpd,ro /httpd/configure-for-host elm.wthrd.com
